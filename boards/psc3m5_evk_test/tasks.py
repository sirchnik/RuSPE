...
from boards.psc3m5_evk_secure_ipc import tasks as secure_ipc_tasks
...
SECURE_BOARD_FN_DIR = NON_SECURE_DIR.parent / "psc3m5_evk_secure"
SECURE_BOARD_IPC_DIR = NON_SECURE_DIR.parent / "psc3m5_evk_secure_ipc"
...
@build_task(default=True, help={"debug": DEBUG_HELP, "ipc": IPC_HELP})
def install(ctx: Context, debug=False, ipc=False):
    """Alias for flash."""

    return flash(ctx, debug=debug, ipc=ipc)
