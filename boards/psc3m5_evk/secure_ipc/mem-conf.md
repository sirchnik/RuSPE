...
See also standard [secure board docs](../secure/mem-conf.md) for general information.
...
- `boards/psc3m5_evk/secure_ipc/layout.ld`: Top-level linker script for the secure IPC SPM image, secure privileged SRAM, and NSC veneer region
- `boards/psc3m5_evk/secure_ipc/secure_layout.ld`: Section placement for the secure IPC SPM image
- `boards/psc3m5_evk/services/*/layout.ld`: Memory-region definitions for each embedded service image
- `boards/psc3m5_evk/test/layout.ld`: Non-secure linker layout for the companion non-secure image
