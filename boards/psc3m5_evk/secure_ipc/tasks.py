...
from boards.psc3m5_evk.services.attest_srv.tasks import build as _attest_build_task
from boards.psc3m5_evk.services.crypto_srv.tasks import build as _crypto_build_task
